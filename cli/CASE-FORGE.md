# Case Forge — start here

This is your local case folder. The free toolkit helps organise records, examine sources and prepare questions. It is not legal advice. You own these files; no app subscription is needed to use the toolkit.
...
Open `HOME.md`, or ask your folder-capable AI: “Read CASE-FORGE.md and help me get started.” You can also open this folder as an Obsidian vault, or use any text editor. Dashboard queries require Obsidian's optional Dataview plugin; ordinary notes do not.
