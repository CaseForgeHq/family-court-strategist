...
const VIEW_TITLES = {
  dashboard: "Case overview", tasks: "Tasks & deadlines", timeline: "Case timeline", evidence: "Evidence matrix",
...
const VIEWS = {
  dashboard: viewDashboard, tasks: () => "", timeline: viewTimeline, evidence: viewEvidence,
...
function go(view) {
  ...
  if (view === "tasks") void tasks.mount($("view"));
  window.scrollTo(0, 0);
}
