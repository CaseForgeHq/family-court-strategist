...
export function createCaseMap({ openRecord, onSelect, loadScene = () => import('./map-scene.js') } = {}) {
  ...
  function mount(element, model) {
    ...
    host.innerHTML = `<div class="case-map-shell"><div class="page-purpose"><p>See how your case records connect.</p><span>Search for a record, select a point or follow a recorded connection.</span></div>
